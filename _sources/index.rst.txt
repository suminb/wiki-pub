.. SB Public Wiki documentation master file, created by
   sphinx-quickstart on Sun Jun  9 20:15:48 2019.
...
Mission Statement
-----------------
Turn *wasted* research hours into public knowledge.

Rationale
---------
Software engineers, including myself, spend a non-trivial amount of time for
going through various resources online (i.e., Google, StackOverflow, etc.) to
search for technical information and knowledge. If we are lucky, we find
information we need without much struggle by scrambling few keywords. However,
if we are unlucky, in which we are in many cases, we end up digging through a
load of documentations and mailing lists like a detective chasing after a crime
suspect.
